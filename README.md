[![Build Status](https://dev.azure.com/oatabati/getstarted/_apis/build/status/atabati.python-sample-vscode-flask-tutorial?branchName=master)](https://dev.azure.com/oatabati/getstarted/_build/latest?definitionId=1&branchName=master)
